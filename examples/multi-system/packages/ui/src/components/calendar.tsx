...
import { CalendarChevronDown, CalendarChevronLeft, CalendarChevronRight } from "@acme/ui/icons"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "cn-calendar-weekday flex-1 rounded-(--cell-radius) font-normal text-muted-foreground select-none",
        ...
        week_number: cn(
          "cn-calendar-week-number text-muted-foreground select-none",
