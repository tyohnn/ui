...
// tyohnn:begin next
// Managed by tyohnn: system graphite · icons lucide. Rewritten by init / add-system; edit outside this block.
...
const tyohnn = {
    ...
    iconAlias: "../../packages/ui/src/icons/libraries/lucide.tsx",
};
// tyohnn:end next
