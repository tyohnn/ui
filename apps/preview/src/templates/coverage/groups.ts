...
export const COVERAGE_GROUPS = [
    { id: "basics", label: "Basics", sections: ["button", "badge", "kbd", "spinner", "separator", "skeleton", "label", "aspect-ratio", "toggle", "toggle-group", "button-group", "direction"] },
    { id: "forms", label: "Forms", sections: ["input", "textarea", "checkbox", "radio-group", "switch", "slider", "progress", "field", "input-group", "input-otp", "native-select", "select"] },
    {
        id: "display",
        label: "Display",
    ...
    { id: "chat", label: "Chat", sections: ["bubble", "message", "message-scroller", "attachment", "questionnaire", "toast"] },
] as const;
